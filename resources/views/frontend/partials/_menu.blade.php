...
<div class="fixed-menu">
  ...
  <div class="bot">
	  ...
	  <span class="bartext">Меню</span>
  </div>
  <div class="sidemenu">
  	<a href="/about" id="link1"><span class="text">О нас</span><span class="fa fa-users"></span></a>
  	<a href="/gallery" id="link2"><span class="text">Галерея</span><span class="fa fa-images"></span></a>
  	<a href="/products" id="link3"><span class="text">Продукция</span><span class="fa fa-th-large"></span></a>
  	<a href="/contacts" id="link4"><span class="text">Контакты</span><span class="fa fa-phone"></span></a>
  </div>
</div>
